...
- Source code  
- A dedicated README with detailed explanation
...
| Project Name | Course | Description | Link |
|--------------|--------|------------|-------|
...
| BLE_Project | CSCI 332 - Embedded Systems (*Fall 2024*) | Display readings from a photocell receptor by communicating through Bluetooth. I was unable to recover the source code, but I have a video presentation and rough PDF report. This project demonstrates some of my experience with embedded systems and BLE communication. | [Link](https://github.com/parkerStacy19/portfolio/tree/main/BLE_Project) [Video](https://youtu.be/BZjiSRv3wuA)|
---
